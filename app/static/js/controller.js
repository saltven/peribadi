// Peribadi configurations that use boolean values and checkboxes
CONFIG_BOOLS = [
    "nojs", "dark", "safe", "alts", "new_tab", "get_only", "tor"
];

// Peribadi configurations that use string values and input fields
CONFIG_STRS = [
    "near", "url"
];
...
const fillConfigValues = () => {
    ...
    xhrGET.onload = function() {
        if (xhrGET.readyState === 4 && xhrGET.status !== 200) {
            alert("Error loading Peribadi config");
            return;
        }
