...
class Request:
    ...
    Attributes:
        ...
        root_path -- the root path of the peribadi instance
        config -- the user's current peribadi configuration
    """
    def __init__(self, normal_ua, root_path, config: Config):
        ...
        if os.environ.get('PERIBADI_PROXY_LOC'):
            auth_str = ''
            if os.environ.get('PERIBADI_PROXY_USER'):
                auth_str = os.environ.get('PERIBADI_PROXY_USER') + \
                           ':' + os.environ.get('PERIBADI_PROXY_PASS')
            self.proxies = {
                'http': os.environ.get('PERIBADI_PROXY_TYPE') + '://' +
                        auth_str + '@' + os.environ.get('PERIBADI_PROXY_LOC'),
            }
